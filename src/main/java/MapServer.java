...
/**
 * This MapServer class is the entry point for running the JavaSpark web server for the
...
public class MapServer {
    ...
    /**
     * The result of rastering is a map containing all of the
    ...
    public static void main(String[] args) {
        ...
        /* Allow for all origin requests (since this is not an authenticated server, don't
         * care about CSRF).  */
